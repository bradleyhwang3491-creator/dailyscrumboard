    ...
    <div style={s.wrap}>
      ...
      <div style={{ ...s.topBar, ...(isMobile ? s.topBarMobile : {}) }}>
        <div style={s.titleArea}>
          <h2 style={{ ...s.pageTitle, ...(isMobile ? { fontSize: "15px" } : {}) }}>Yearly Task Board</h2>
      ...
      <div style={{ ...s.filterBar, ...(isMobile ? s.filterBarMobile : {}) }}>
        ...
        {hasFilter && (
          <button style={isMobile ? s.resetBtnFull : s.resetBtn} onClick={() => { setFilterTm1(""); setFilterUser(""); }}>
            {t("common.reset")}
          </button>
        )}
      </div>
...
const s = {
  ...
  card: {
    ...
    borderLeft: "3px solid #CBD5E1", /* default, overridden per user */
  },
