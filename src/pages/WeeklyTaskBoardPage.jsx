  ...
  return (
    <div style={s.wrap}>
      ...
      <div style={s.filterBar}>
        ...
        {hasFilter && (
          <button style={s.resetBtn} onClick={() => { setFilterTm1(""); setFilterUser(""); }}>초기화</button>
        )}
      </div>
        ...
        <div style={s.weekTabs}>
          {WEEKS.map(w => {
            ...
            return (
              ...
              >
                <span style={s.weekTabLabel}>{w}주차</span>
          ...
          <div style={{ minWidth: totalW }}>
              ...
              {viewMode === "week" && WEEKS.map(w => {
                ...
                return (
                  <div key={w} style={{ ...s.th, ...(cur ? s.thCurrent : cnt > 0 ? s.thHasData : {}) }}>
                    <div style={s.thInner}>
                      <span style={cur ? s.thLabelCur : s.thLabel}>{w}주차</span>
            ...
            {tableRows.length === 0 ? (
              <div style={s.emptyBox}>
                {hasFilter ? "조회 조건에 해당하는 업무가 없습니다." : "해당 기간에 등록된 업무가 없습니다."}
              </div>
            ) : (
              tableRows.map(row => (
  ...
  return (
    <div style={ms.overlay} onClick={onClose}>
      <div style={ms.modal} onClick={e => e.stopPropagation()}>
        ...
        <div style={ms.body}>
          <div style={ms.fullRow}><label style={ms.label}>제목</label><input style={inp} type="text" readOnly value={task.title} /></div>
          <div style={ms.twoCol}>
            <div style={ms.fieldWrap}><label style={ms.label}>등록일자</label><input style={inp} type="text" readOnly value={task.regDate} /></div>
            <div style={ms.fieldWrap}><label style={ms.label}>상태</label><input style={inp} type="text" readOnly value={STATUS_TEXT[task.status] || task.status} /></div>
          </div>
          <div style={ms.twoCol}>
            <div style={ms.fieldWrap}><label style={ms.label}>업무구분1</label><input style={inp} type="text" readOnly value={getTaskName(tm1, task.taskType1Cd)} /></div>
            <div style={ms.fieldWrap}><label style={ms.label}>업무구분2</label><input style={inp} type="text" readOnly value={getTaskName(tm2, task.taskType2Cd)} /></div>
          </div>
          <div style={ms.twoCol}>
            <div style={ms.fieldWrap}><label style={ms.label}>업무구분3</label><input style={inp} type="text" readOnly value={getTaskName(tm3, task.taskType3Cd)} /></div>
            <div style={ms.fieldWrap}><label style={ms.label}>업무구분4</label><input style={inp} type="text" readOnly value={getTaskName(tm4, task.taskType4Cd)} /></div>
          </div>
          <div style={ms.halfRow}>
            <div style={ms.fieldWrap}><label style={ms.label}>중요도</label><input style={inp} type="text" readOnly value={task.priority} /></div>
          </div>
          <div style={ms.fullRow}><label style={ms.label}>연관페이지링크</label><input style={inp} type="text" readOnly value={task.relatedLink} /></div>
          <div style={ms.fullRow}><label style={ms.label}>작업내용</label><textarea style={{ ...ms.textarea, ...ms.inputRO }} readOnly value={task.content} /></div>
          <div style={ms.fullRow}><label style={ms.label}>팀장공유내용</label><textarea style={{ ...ms.textarea, ...ms.inputRO }} readOnly value={task.teamNote} /></div>
          ...
          <div style={ms.twoCol}>
            <div style={ms.fieldWrap}><label style={ms.label}>작업완료예정일자</label><input style={inp} type="text" readOnly value={task.plannedEnd} /></div>
            <div style={ms.fieldWrap}><label style={ms.label}>작업완료일자</label><input style={inp} type="text" readOnly value={task.actualEnd} /></div>
          </div>
        </div>
        <div style={ms.footer}>
